...
import { LayoutDashboard, Users, Bell, Building2, Map, BarChart2, LogOut } from 'lucide-react'
            ...
            <div className="w-9 h-9 rounded-xl bg-primary-500 flex items-center justify-center shrink-0">
              <img
                ...
                onError={(e) => {
                  ...
                  e.currentTarget.parentElement.innerHTML = '<span style="color:white;font-weight:700;font-size:13px">GA</span>'
                }}
              />
            </div>
            <div>
              <p className="font-bold text-sm text-gray-800 leading-tight tracking-tight">Granja Almeyra</p>
              <p className="text-[10px] text-gray-400 mt-0.5">CRM Comercial</p>
            </div>
          </div>
        </div>
