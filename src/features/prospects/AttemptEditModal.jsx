...
import {
  Instagram, MessageCircle, FileText, Phone, MapPin, Edit3, Trash2,
} from 'lucide-react'
...
export function AttemptEditModal({ open, onClose, attempt, prospect, onSave, onDelete, loading }) {
  ...
  return (
    <Modal
      open={open}
      onClose={onClose}
      title={`Editar intento — ${prospect?.name ?? ''}`}
      size="md"
      footer={
        <div className="flex items-center justify-between w-full">
          ...
          >
            <Trash2 size={14} />
            {confirmDelete ? '¿Confirmar eliminación?' : 'Eliminar intento'}
          </Button>
