      ...
      <div className="w-full max-w-md bg-white rounded-card shadow-card p-8 md:p-10">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-text-primary">Granja Almeyra</h1>
            <p className="text-sm text-text-muted italic mt-0.5">El origen de los mejores huevos</p>
          </div>
